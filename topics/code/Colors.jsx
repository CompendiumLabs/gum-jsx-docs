...
return <Svg>
  <Box padding={px(24)} background={lightgray}>
    <VStack gap={px(16)}>
      <Text font-size={px(26)} font-weight={bold}>Numbers into colors</Text>
      ...
      <HStack gap={px(14)}>
        {linspace(0, 1, 5).map(t => <VStack gap={px(6)} align="center">
          <Square width={px(60)} fill={interp(white, blue, t)} stroke={darkgray} />
          <Text font-family={mono} font-size={px(14)}>{rounder(t)}</Text>
        </VStack>)}
      </HStack>
    </VStack>
  </Box>
