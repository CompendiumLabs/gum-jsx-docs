...
[Box and Frame](/docs/Box) pass their rounding through to this element. Their corners use the same stroke units around text and geometry; changing text `scale` alone does not change the radius.
