...
`head_size` defaults to `px(9)`, `head_width` to `0.65`. `open` draws two stroked barbs; a closed
head uses fill. Curved barbs and per-end shape customization are deferred.
