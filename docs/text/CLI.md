...
```sh
bun run gum gum-next-docs/docs/code/CLI.jsx
bun run gum gum-next-docs/docs/code/CLI.jsx -o /tmp/cli.svg
bun run gum gum-next-docs/docs/code/CLI.jsx -W 320 -o /tmp/cli.png --ratio 2
bun run gum gum-next-docs/docs/code/CLI.jsx -f tree --stats
bun run gum --help
```
