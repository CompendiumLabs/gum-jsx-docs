...
<Svg width={px(540)} font-size={px(16)} color={slate}>
  <Box width={1} padding={px(20)}>
    <VStack width={1} gap={px(22)}>
      <VStack width={1} gap={px(8)}>
        <Text font-size={px(13)} color={slate}>BASELINES / independent font sizes</Text>
        <HStack gap={px(14)} align="baseline">
          <Text font-size={px(16)}>Small</Text>
          <Text font-size={px(32)} font-weight={bold}>Large</Text>
          <Text font-size={px(22)} font-style="italic" color={blue}>Aligned</Text>
          <Square width={px(26)} fill={red} stroke={none} />
        </HStack>
      </VStack>
      <VStack width={1} gap={px(8)}>
        <Text font-size={px(13)} color={slate}>PACKING / equal space between fixed items</Text>
      ...
      <VStack width={1} gap={px(8)}>
        <Text font-size={px(13)} color={slate}>STRETCH / the reflowed text sets the height</Text>
