...
<Box font-size={px(32)} padding={em(1)}>
  <VStack gap={em(0.8)} align="start">
    ...
    <MathText>a<MathText color={red}>+b</MathText>=c</MathText>
    ...
    <MathText>a<MathBox padding={[em(0.1), em(0.2)]}><MathSymbol text="+" /></MathBox>b</MathText>
    <MathRule width={em(12)} color={blue} />
  </VStack>
</Box>
