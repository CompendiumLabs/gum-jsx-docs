...
A piecewise linear path through points records {x,y}. Null/nonfinite samples break the path. closed closes each finite run. Paint uses ordinary fill/stroke styles.
