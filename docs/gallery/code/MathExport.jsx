...
const exportOptions = { font_size: px(30), padding: em(0.2) }
return (
  <Box font-size={px(18)} padding={em(1.3)}>
    <VStack gap={em(1.1)} align="start">
      ...
      {mathToElement(formula, { ...exportOptions, font_size: px(48), color: blue })}
      <Text>Contain scales the completed 30-pixel formula into the available width.</Text>
