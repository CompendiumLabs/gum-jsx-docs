...
const cards = [
  {
    title: 'Circle', color: blue, note: 'A circular outline inside its allocated rectangle.',
    symbol: <Circle x={0.5} y={0.5} anchor="center" width={px(88)} fill={blue} stroke={none} />,
  },
  {
    title: 'Square', color: red, note: 'A square silhouette with gently rounded corners.',
    symbol: <Square x={0.5} y={0.5} anchor="center" width={px(88)} radius={px(12)} fill={red} stroke={none} />,
  },
  {
    title: 'Polygon', color: green, note: 'Explicit points joined into a closed, filled path.',
