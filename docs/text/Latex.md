...
*Inherits*: [MathText](/docs/MathText) > [MathRow](/docs/MathRow) > [Group](/docs/Group) > [Element](/docs/Element)
...
- `scale` = `1` — size relative to the surrounding em, as with [Text](/docs/Text); also supported by `Tex`
