...
1. Use [Svg](Svg.md) for the viewport.
2. Use [Box](Box.md) or [Frame](Frame.md) for padding and decoration.
3. Arrange content with [HStack](HStack.md), [VStack](VStack.md), or [Group](Group.md).
4. Add [shapes](Rect.md) and [Text](Text.md).
...
- Text keeps its font size during layout. [Fit](Fit.md) is the explicit operation
...
bun run gum gum-next-docs/docs/code/Gum.jsx -o /tmp/hello.svg
```
