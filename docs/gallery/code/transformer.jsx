...
const Block = ({ id, label, color }) => (
  <Node
    ...
    padding={px(8)} radius={px(7)} background={tint(color)}
        ...
        >
          ...
          <VStack x={px(20)} y={px(0)} width={px(420)} gap={px(gap)} align="center">
            ...
            <Frame
              ...
              border-width={px(layerBorder)} radius={px(12)}
            >
