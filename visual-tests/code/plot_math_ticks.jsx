// Formula tick labels, titles, and legend entries share the plot's font context.
const ticks = [
  [0, <Tex>0</Tex>],
...
return (
  <Svg width={px(820)} height={px(470)} font-size={px(18)}>
    <Plot
      title={<Text>{"Trigonometry: "}<Tex>{String.raw`\sin^2x+\cos^2x=1`}</Tex></Text>}
      xlabel={<Tex>x</Tex>}
      ylabel={<Tex>f(x)</Tex>}
      xlim={[0, tau]}
      ylim={[-1.2, 1.2]}
