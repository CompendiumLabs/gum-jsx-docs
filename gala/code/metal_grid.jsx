...
return <Frame border={2} rounded={20} fill={darkgray} padding={0.03} margin>
  <Frame rounded={12} fill={black} padding={0.025}>
    <Grid rows={n} cols={m} opacity={0.7}>
      {range(0, n*m).map(i => <Rectangle rounded={8} fill={pal(i%m)} /> )}
    </Grid>
